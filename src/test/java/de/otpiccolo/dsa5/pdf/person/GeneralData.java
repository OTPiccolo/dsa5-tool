...
/**
 * Character comprehensive data that can be added to different characters.
 */
public class GeneralData {
	 ...
	 *
	 * @return A page containing the data.
	 */
	public static final IPage getZauberModPage() {
		final DefaultPage modPage = new DefaultPage("Zauber-/Predigt-Modifkationen");
